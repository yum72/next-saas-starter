      ...
      <HomepageWrapper>
        <WhiteBackgroundContainer>
          <HeroWrapper>
            <Contents>
              <Heading>
                Leverage our top-tier network of researchers, grad students, entrepreneurs, industry and TTOs focused on commercializing
                meaningful deeptech research.
              </Heading>
              <SignUpText>Sign up here to periodically hear about: </SignUpText>
              <Description>
                <ul>
                  <li>Problem statements from our industry partners</li>
                  <li>New startups that form within our network</li>
                  <li>New tech transfer licensing/commercialization opportunities</li>
                  <li>Promising PhDs/Masters students for contract work or portfolio company hires </li>
                </ul>
              </Description>
